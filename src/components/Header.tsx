...
export default function Header() {
  return (
    <header className="fixed inline-flex h-16 w-full items-center justify-between self-stretch bg-indigo-400 px-8 py-3 shadow-[0px_2px_4px_0px_rgba(0,0,0,0.25)]">
      {/* Logo */}
